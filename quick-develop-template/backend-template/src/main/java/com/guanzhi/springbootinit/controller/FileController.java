...
import com.guanzhi.springbootinit.constant.FileConstant;
import com.guanzhi.springbootinit.exception.BusinessException;
import com.guanzhi.springbootinit.manager.OssManager;
    ...
    public BaseResponse<String> uploadFile(@RequestPart("file") MultipartFile multipartFile,
        ...
        try {
            ...
            if (file != null) {
                ...
                user.setUserAvatar(FileConstant.COS_HOST + filepath);
